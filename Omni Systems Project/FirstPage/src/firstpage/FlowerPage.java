...
{   
    ...
    public FlowerPage()
    {
        ...
        welcomeLabel = new JLabel("click the flower name to order 1 square foot; you can click multiple times");
        ...
        sub1.add(button1); 
        sub1.add(new JLabel(new ImageIcon("zinnia.png")));
        ...
        sub2.add(button3);
        sub2.add(new JLabel(new ImageIcon("daisy.png")));
        ...
        sub3.add(button5);
        sub3.add(new JLabel(new ImageIcon("cosmos.png")));

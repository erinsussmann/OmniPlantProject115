...
public class GroundcoverPage implements ActionListener
{   
    ...
    public GroundcoverPage()
    {
        frame = new JFrame("Groundcover Page");
        ...
        welcomeLabel = new JLabel("click the groundcover name to order 1 square foot; you can click multiple times");
        ...
        sub1.add(button1); 
        sub1.add(new JLabel(new ImageIcon("acorus.png")));
        ...
        sub2.add(button3);
        sub2.add(new JLabel(new ImageIcon("devian.png")));
        ...
        sub3.add(button5);
        sub3.add(new JLabel(new ImageIcon("sage.png")));
